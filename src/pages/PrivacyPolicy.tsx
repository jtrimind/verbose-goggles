        ...
        <div className="min-h-screen bg-white flex flex-col font-sans">
            ...
            <main className="flex-grow pt-[110px] pb-20 px-6">
                <div className="max-w-[800px] mx-auto">
                    <h1 className="text-3xl md:text-4xl font-bold mb-8 tracking-tighter text-gray-900">Privacy Policy</h1>
                    ...
                    <div className="prose prose-lg text-gray-600 leading-relaxed">
                        ...
                        <section className="mb-10">
                            ...
                            <p>
                                Welcome to the Samsung Tech Blog. We value your privacy and are committed to protecting your personal data.
